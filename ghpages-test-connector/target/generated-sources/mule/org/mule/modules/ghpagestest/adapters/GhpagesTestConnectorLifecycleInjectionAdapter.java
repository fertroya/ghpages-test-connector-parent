...
/**
 * A <code>GhpagesTestConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link GhpagesTestConnector } that adds lifecycle methods to the pojo.
 * 
 */
...
public class GhpagesTestConnectorLifecycleInjectionAdapter
    extends GhpagesTestConnectorMetadataAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(GhpagesTestConnectorLifecycleInjectionAdapter.class);
